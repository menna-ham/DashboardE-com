...
// Define FormValues to represent the form structure
...
interface DragAndDropFileInputProps {
  label: string;
  name: string; // Ensure it's a key of FormValues
  galleryFieldName: keyof FormValues; // Ensure it's a key of FormValues
  accept?: string; // File types accepted
  placeholderImage: string; // Placeholder image URL
  multiple?: boolean; // Specify if multiple files should be handled
