...
const GradientYAxisChart: React.FC = () => {
  const data = [
  ...
  const option = {
    visualMap: {
      ...
      max: 400,
      inRange: {
        color: ['#F89273', '#E1D9D8', '#544EAB']  // Gradient colors along Y-axis
      }
    },
    title: {
      left: 'center',
        ...
        areaStyle: {
          color: {
            ...
            colorStops: [
              {
                offset: 0,
                color: '#FDE6E1' // Top color
              },

            ]
          }
        }   // Optional: Add an area gradient if needed
      }
    ]
  };
...
export default GradientYAxisChart;
